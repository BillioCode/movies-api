    ...
    <header>
        <nav className="bg-white border-gray-200 dark:bg-gray-900">
            ...
            <Link href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
              ...
              <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">CineMovies</span>
            </Link>

            
            <div className="flex md:order-2">
              <button
                type="button" onClick={() => setHidden(!hidden)}
              ...
              <div className={`relative ${hidden ? "hidden" : ""} md:block`}>
              ...
              <button
                data-collapse-toggle="navbar-search" onClick={() => setHidden(!hidden)}
                type="button"
